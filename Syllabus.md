...
See the official syllabus here: https://chapman.simplesyllabus.com/doc/83ufcxxwr/Fall-2026-CPSC-292-01-%28S%29-Intro-Exploratory-Data-Analys?mode=view

### Basic Course Information

 - __Class numbers:__ 2166 (Section 01), 2167 (Section 02)
 - __Units:__ 3 units 
 - __Lecture Time:__ Section 01: MWF, 9:00 -- 9:50 am; Section 02: 10:00 -- 10:50 pm
 - __Lecture Location:__ Leatherby Libraries Lab B14
 - __Course Canvas Site: TBA
  - __Course Info Repository:__ https://github.com/CPSC-292/Fall2026-CourseInfo/
...
__Instructor:__ Lindsay Waldrop, Ph.D. (she/her/hers)
 ...
 - _Office Hours:_ Wednesdays 1 pm - 2:30 pm; Tuesdays 10:30 am - 12 pm; by appointment.
...
Each category of work is weighted as the following percentage of the total grade: 
Exams -- 60%
Projects -- 20%
Assignments -- 20%

From this percentage, course letter grades will be determined based on the following 10-point scale: A: >= 93, A-: 92 -- 90, B+: 87 -- 89, B: 83 -- 86, B-: 80 -- 82, C+: 77 -- 79, C: 73 -- 76, C-: 70 -- 72, D+: 67 -- 69, D: 63 -- 66, D-: 60 -- 62, F: < 60.
...
The unrestricted use of GenAI is permitted in this course on all types of work *except* in-class assignments and exams. GenAI is not permitted for use on any Exam material in this course.  
...
__Electronic Devices__ (phones, smart glasses, computers, etc): *No electronic devices will not be allowed for use in class unless explicitly stated by the instructor.* No VR, augmented reality, smart watches, or smart glasses will be allowed in the classroom __at any time.__ Switch cell phones to silent/vibrate and stow them during class. You may not make video and/or audio recordings of the lectures or the content of the class. If you have a documented accommodation, please contact the instructor.

__Group Work__: Group work is encouraged on all assignments and during class, except those explicitly stated to be _individual evaluations_. You are free to assume that an assignment is meant to be worked on together unless otherwise directed. If you work in groups, simply list the members of your group on the top of the assignment. Exams are always considered individual evaluations. Projects will cover collaboration in the instructions.
